        ...
        <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #0A3D6B 0%, #1565C0 100%); border-radius: 20px;">
            <div class="card-body py-5 px-4 text-white">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h3 class="fw-bold mb-1 text-white">Selamat Datang, <?php echo e(auth()->user()->name); ?></h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <span>Perusahaan: <strong><?php echo e(auth()->user()->company->name); ?></strong></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-2">
                                <i class="fas fa-envelope me-2 opacity-75"></i>
                                <span>Email: <strong><?php echo e(auth()->user()->email); ?></strong></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card h-100 border-0 shadow-sm" style="border-radius: 16px; overflow: hidden; transition: transform 0.2s ease;">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    ?>
                    <span class="badge <?php echo e($badgeClass); ?> px-3 py-2 rounded-pill" style="font-weight: 600;">
                        <?php echo e($statusText); ?>

                    </span>
                    <small class="text-muted fw-semibold">
                        <i class="far fa-calendar-alt me-1"></i><?php echo e($s->created_at->format('d M Y')); ?>

                    </small>
                </div>
                
                <h5 class="fw-bold text-dark mb-2 line-clamp-2" style="min-height: 48px;"><?php echo e($s->subject); ?></h5>
                <p class="text-muted mb-3 fs-sm"><i class="fas fa-tag me-2 text-primary"></i><?php echo e($s->category); ?></p>
                ...
                <a href="<?php echo e(route('company.services.show', $s)); ?>" class="btn w-100 fw-bold shadow-sm" style="background-color: #f8fafc; border: 1px solid #e2e8f0; color: var(--ppsdk-primary); border-radius: 10px;">
                    <i class="fas fa-arrow-right me-2"></i> <?php echo e($s->status === 'draft' ? 'Beri Tanggapan' : 'Lihat Detail'); ?>
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pelayanan psdkp\resources\views/company/dashboard.blade.php ENDPATH**/ ?>