<?php $__env->startSection('title', 'Jadwal Kedatangan'); ?>
<?php $__env->startSection('page-title', 'Jadwal Kedatangan'); ?>
...
<div class="jadwal-page">
    ...
    <div class="hero-stats">
        <a href="<?php echo e(route('jadwal.index', ['filter' => 'today'])); ?>" class="hero-stat-card today-card <?php echo e($filter == 'today' ? 'active-filter' : ''); ?>">
        ...
        <a href="<?php echo e(route('jadwal.index', ['filter' => 'upcoming'])); ?>" class="hero-stat-card upcoming-card <?php echo e($filter == 'upcoming' ? 'active-filter' : ''); ?>">
            <div class="stat-icon-wrap">
                <i class="fas fa-clock"></i>
            </div>
            <div class="stat-number"><?php echo e($stats['upcoming']); ?></div>
            <div class="stat-label">Akan Datang</div>
        </a>
        <a href="<?php echo e(route('jadwal.index', ['filter' => 'past'])); ?>" class="hero-stat-card past-card <?php echo e($filter == 'past' ? 'active-filter' : ''); ?>">
            <div class="stat-icon-wrap">
                <i class="fas fa-history"></i>
            </div>
            <div class="stat-number"><?php echo e($stats['past']); ?></div>
    ...
    <div class="filter-bar">
        <a href="<?php echo e(route('jadwal.index', ['filter' => 'today'])); ?>" class="filter-btn <?php echo e($filter == 'today' ? 'active-today' : ''); ?>">
            <i class="fas fa-sun"></i> Hari Ini
        </a>
        <a href="<?php echo e(route('jadwal.index', ['filter' => 'upcoming'])); ?>" class="filter-btn <?php echo e($filter == 'upcoming' ? 'active-upcoming' : ''); ?>">
            <i class="fas fa-arrow-right"></i> Akan Datang
        </a>
        <a href="<?php echo e(route('jadwal.index', ['filter' => 'past'])); ?>" class="filter-btn <?php echo e($filter == 'past' ? 'active-past' : ''); ?>">
            <i class="fas fa-hourglass-end"></i> Sudah Lewat
        </a>
        <a href="<?php echo e(route('jadwal.index', ['filter' => 'all'])); ?>" class="filter-btn <?php echo e($filter == 'all' ? 'active-all' : ''); ?>">
    ...
    <?php if($schedules->count() > 0): ?>
        ...
        ?>
        <div class="schedule-card <?php echo e($isToday ? 'is-today' : ''); ?> <?php echo e($isPast ? 'is-past' : ''); ?>" style="animation-delay: <?php echo e($i * 0.08); ?>s;">
            <div class="schedule-card-inner">
                
                
                <div class="date-column">
                    <div class="date-big"><?php echo e($s->arrival_date->format('d')); ?></div>
                    <div class="date-month"><?php echo e($s->arrival_date->translatedFormat('M Y')); ?></div>
                    <div class="time-badge">
                        <i class="fas fa-clock me-1"></i><?php echo e($s->arrival_time); ?>
                ...
                <div class="info-column">
                    <div class="ship-name">
                        ...
                        <?php echo e($s->ship->name ?? '-'); ?>

                    </div>
                    <div class="owner-name">
                        <i class="fas fa-user-tie"></i> <?php echo e($s->company->name ?? '-'); ?>

                    </div>
                    <div class="subject-text">
                        <?php echo e(Str::limit($s->subject, 70)); ?>
                    ...
                    <div class="doc-tags">
                        <?php $__currentLoopData = $s->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="doc-tag">
                            <i class="fas fa-file-alt"></i> <?php echo e($doc->type ?? $doc->original_name); ?>
                ...
                <div class="action-column">
                    <a href="<?php echo e(route('services.show', $s->id)); ?>" class="action-btn primary">
                        <i class="fas fa-file-alt"></i> Lihat Detail
                    </a>
                    <?php if($s->company && $s->company->phone): ?>
                    <a href="https://wa.me/62<?php echo e(ltrim($s->company->phone, '0')); ?>" target="_blank" class="action-btn whatsapp">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pelayanan psdkp\resources\views/admin/jadwal.blade.php ENDPATH**/ ?>