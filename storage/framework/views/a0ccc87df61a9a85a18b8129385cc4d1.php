...
<head>
    ...
    <title>Login | PSDKP Pelayanan</title>
                        ...
                        <form method="POST" action="<?php echo e(route('login.attempt')); ?>">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control border-start-0 ps-0" required autofocus placeholder="Masukkan email">
                                </div>
                            </div>
                            ...
                            <a href="<?php echo e(route('login.company')); ?>" class="btn w-100 fw-bold" style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 0.8rem; background: #f8fafc; color: #475569; transition: all 0.2s;">
                                <i class="fas fa-ship me-2"></i> Login Khusus Pemilik Kapal
                            </a>
                        </form>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\pelayanan psdkp\resources\views/auth/login.blade.php ENDPATH**/ ?>