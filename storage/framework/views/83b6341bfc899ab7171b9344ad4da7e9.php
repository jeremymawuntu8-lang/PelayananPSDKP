...
<div class="premium-header">
    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo PSDKP">
    <h3>PSDKP Pelayanan</h3>
    <p class="mb-0"><i class="fas fa-ship me-2"></i><?php echo e($service->ship->name ?? 'Kapal Tidak Diketahui'); ?></p>
</div>
...
<div class="public-wrap">
    ...
    <div class="glass-card mt-4">
        ...
        <div class="row">
            <div class="col-12 col-md-12 mt-2">
                ...
                <div class="info-value"><?php echo e($service->subject); ?></div>
            </div>
            <div class="col-6 col-md-6 mt-2">
                <div class="info-label">Pemilik Kapal</div>
                <div class="info-value"><?php echo e($service->company->name ?? '-'); ?></div>
            </div>
            <div class="col-6 col-md-6 mt-2">
                <div class="info-label">Tgl Pengamatan</div>
                <div class="info-value"><?php echo e($service->observation_date ? $service->observation_date->format('d M Y') : '-'); ?></div>
            </div>
            
            <div class="col-12 mt-2">
                <div class="info-label">Indikasi</div>
                <div class="info-value danger"><i class="fas fa-exclamation-triangle me-1"></i> <?php echo e($service->indikasi ?? '-'); ?></div>
            </div>
            
            <div class="col-12 mt-2">
                <div class="info-label">Analisis</div>
                <div class="info-value" style="font-weight: 500;"><?php echo e($service->analysis ?? '-'); ?></div>
            </div>
            
            <div class="col-12 mt-2">
                <div class="info-label">Dugaan Pelanggaran</div>
                <div class="info-value"><?php echo e($service->duga_langgar ?? '-'); ?></div>
            </div>
            ...
            <div class="col-6 col-md-6 mt-2">
                ...
                <div class="info-value"><?php echo e($service->pelabuhan_keluar_terakhir ?? '-'); ?></div>
            </div>
            <div class="col-6 col-md-6 mt-2">
                <div class="info-label">UPT Terdekat</div>
                <div class="info-value"><?php echo e($service->upt_terdekat ?? '-'); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card">
        ...
        <div class="d-flex flex-column gap-3 mt-3">
            ...
            <div class="d-flex justify-content-between align-items-center p-3 rounded-3" style="background: #F8FAFC; border: 1px solid #E2E8F0;">
                <div>
                    <div class="fw-bold text-dark" style="font-size: 0.9rem;"><?php echo e($doc->type ?? 'Dokumen'); ?></div>
                    <div class="text-muted" style="font-size: 0.75rem;"><?php echo e($doc->nomor_surat ?? 'Tanpa Nomor'); ?></div>
                </div>
                <a href="<?php echo e(asset('storage/'.$doc->file_path)); ?>" target="_blank" class="btn btn-sm btn-primary rounded-circle shadow-sm" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center;">
    ...
    <div class="glass-card">
        ...
        <?php if(session('success')): ?>
            <div class="alert alert-success d-flex align-items-center rounded-3 mb-4 shadow-sm" style="border:none; border-left: 4px solid #10B981; background: #ECFDF5;">
                ...
                <div>
                    ...
                    <div style="font-size:0.9rem; color: #065F46;"><?php echo e(session('success')); ?></div>
                </div>
            </div>
        <?php endif; ?>

        <?php if($service->status == 'submitted'): ?>
        ...
        <?php else: ?>
            ...
            <form action="<?php echo e(route('public.form.store', $service->token)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                
                <div class="row g-3 mb-4">
                    <div class="col-6 col-md-4">
                        <label class="form-label">Tanggal Datang <span class="text-danger">*</span></label>
                        <input type="date" name="arrival_date" id="arrival_date" class="form-control" value="<?php echo e(old('arrival_date', $service->arrival_date?->format('Y-m-d'))); ?>" required>
                    </div>
                    <div class="col-6 col-md-4">
                        <label class="form-label">Hari <span class="text-danger">*</span></label>
                        <input type="text" name="arrival_day" id="arrival_day" class="form-control" value="<?php echo e(old('arrival_day', $service->arrival_day)); ?>" readonly required style="background-color: #E2E8F0; cursor: not-allowed; color: #64748B;">
                    </div>
                    <div class="col-12 col-md-4 mt-3 mt-md-0">
                        ...
                        <select name="arrival_time" class="form-select" required>
                            ...
                            <option value="09:00" <?php echo e(old('arrival_time', $service->arrival_time) == '09:00' ? 'selected' : ''); ?>>09:00</option>
                            <option value="11:00" <?php echo e(old('arrival_time', $service->arrival_time) == '11:00' ? 'selected' : ''); ?>>11:00</option>
                            <option value="14:00" <?php echo e(old('arrival_time', $service->arrival_time) == '14:00' ? 'selected' : ''); ?>>14:00</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="attendance-options">
                        <div class="radio-card">
                            <input type="radio" name="attendance_type" id="hadir_pemilik" value="pemilik" <?php echo e(old('attendance_type', $service->attendance_type) == 'pemilik' ? 'checked' : ''); ?> required>
                            <label for="hadir_pemilik"><i class="fas fa-user-tie"></i> Pemilik</label>
                        </div>
                        <div class="radio-card">
                            <input type="radio" name="attendance_type" id="hadir_nahkoda" value="nahkoda" <?php echo e(old('attendance_type', $service->attendance_type) == 'nahkoda' ? 'checked' : ''); ?> required>
                            <label for="hadir_nahkoda"><i class="fas fa-ship"></i> Nahkoda</label>
                        </div>
                        <div class="radio-card">
                            <input type="radio" name="attendance_type" id="diwakilkan" value="diwakilkan" <?php echo e(old('attendance_type', $service->attendance_type) == 'diwakilkan' ? 'checked' : ''); ?> required>
                ...
                <div class="mb-4" id="keterangan_kehadiran_container" style="display: none;">
                    <div class="p-3 bg-light border rounded">
                        ...
                        <input type="text" name="attendance_notes" id="attendance_notes" class="form-control mb-3" value="<?php echo e(old('attendance_notes', $service->attendance_notes)); ?>" placeholder="Contoh: Budi (Manajer)">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="response" class="form-control" rows="4" placeholder="Tulis penjelasan Anda di sini..."><?php echo e(old('response', $service->company_response)); ?></textarea>
                </div>
    ...
    <div class="text-center mt-4 mb-3">
        <small class="text-muted fw-semibold">&copy; <?php echo e(date('Y')); ?> Direktorat Jenderal PSDKP.</small>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\pelayanan psdkp\resources\views/services/public.blade.php ENDPATH**/ ?>