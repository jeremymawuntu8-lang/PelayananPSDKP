...
Route::middleware('auth')->group(function(){
 ...
 Route::middleware('role:admin,petugas')->group(function(){Route::resource('/pelayanan',ServiceRequestController::class)->names('services')->parameters(['pelayanan' => 'service'])->only(['index','create','store','show']);Route::patch('/pelayanan/{service}/status',[ServiceRequestController::class,'updateStatus'])->name('services.status');Route::get('/companies',[CompanyController::class,'index'])->name('companies.index');Route::get('/companies/create',[CompanyController::class,'create'])->name('companies.create');Route::post('/companies',[CompanyController::class,'store'])->name('companies.store');Route::get('/companies/{company}/edit',[CompanyController::class,'edit'])->name('companies.edit');Route::put('/companies/{company}',[CompanyController::class,'update'])->name('companies.update');Route::delete('/companies/{company}',[CompanyController::class,'destroy'])->name('companies.destroy');Route::resource('/ships',ShipController::class)->only(['index','create','store','edit','update','destroy'])->names('ships'); Route::delete('/jadwal/{jadwal}', [\App\Http\Controllers\JadwalController::class, 'destroy'])->name('jadwal.destroy');});
