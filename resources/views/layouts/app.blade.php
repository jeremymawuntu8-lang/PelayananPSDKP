...
<div class="app-wrapper">
            ...
            <ul class="navbar-nav ms-auto d-flex align-items-center gap-2">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#" data-bs-toggle="dropdown">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'U') }}&background=0A5C6B&color=fff&size=32"
                             class="rounded-circle" width="32" height="32" alt="">
                        <span class="d-none d-md-inline fw-semibold" style="font-size: 0.84rem;">{{ auth()->user()->name ?? '' }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><span class="dropdown-item-text text-muted" style="font-size: 0.78rem;">{{ auth()->user()->email ?? '' }}</span></li>
                        <li><span class="dropdown-item-text"><span class="badge bg-primary">{{ strtoupper(auth()->user()->role ?? '') }}</span></span></li>
    ...
    <aside class="app-sidebar shadow-lg" data-bs-theme="dark">
        ...
        <div class="sidebar-wrapper">
            <nav class="mt-2">
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('ships.index') }}" class="nav-link {{ request()->routeIs('ships.*') ? 'active' : '' }}">
        ...
        <div class="sidebar-user-panel d-flex align-items-center">
            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'U') }}&background=0E8A9E&color=fff&size=36"
            ...
            <div class="flex-grow-1 overflow-hidden">
                ...
                <div class="text-white-50" style="font-size: 0.72rem;">{{ ucfirst(auth()->user()->role ?? 'User') }}</div>
            </div>
        </div>
    </aside>
