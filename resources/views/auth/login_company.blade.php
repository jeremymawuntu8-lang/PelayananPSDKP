            ...
            <div class="card login-card fade-in">
                <div class="row g-0">
                    ...
                    <div class="col-md-7 p-4 p-md-5 p-xl-5 d-flex flex-column justify-content-center">
                        ...
                        <div class="mt-2 mb-5">
                            <a href="{{ route('google.redirect') }}" class="btn w-100 fw-bold d-flex align-items-center justify-content-center gap-3" style="border: 2px solid #e2e8f0; border-radius: 12px; padding: 1rem; background: #fff; color: #475569; transition: all 0.2s; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
                        ...
                        <div class="text-center">
                            <a href="{{ route('login') }}" class="text-muted small text-decoration-none hover-primary">
