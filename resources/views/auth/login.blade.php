                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-7 p-4 p-md-5 p-xl-5 d-flex flex-column justify-content-center">
                        ...
                        <form method="POST" action="{{ route('login.attempt') }}">
                            ...
                            <a href="{{ route('login.company') }}" class="btn w-100 fw-bold" style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 0.8rem; background: #f8fafc; color: #475569; transition: all 0.2s;">
